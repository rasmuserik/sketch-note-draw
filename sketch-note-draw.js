...
(function() {
  var addButtons, allStrokes, buttonAwesome, buttonFns, buttonList, calcPos, ctx, currentStroke, dist, drawEntry, drawGrid, drawSegment, findDimensions, gridCols, gridEvents, gridMargin, gridNext, gridSize, gridStart, gridX0, gridY0, hasTouch, hold, kind, layout, loadDB, loadGrid, loadGridExit, loadGridHandleTouch, multitouch, nextPath, nextStroke, onReady, panPos, redo, redraw, rootX, rootY, save, scale, scaleFit, showLoadGrid, strokes, touchend, touchmove, touchstart, transform, use, zoomFn;
