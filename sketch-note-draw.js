...
(function() {
  var addButtons, allStrokes, buttonAwesome, buttonFns, buttonList, calcPos, ctx, currentStroke, dist, drawEntry, drawGrid, drawSegment, gridCols, gridEvents, gridMargin, gridNext, gridSize, gridStart, gridX0, gridY0, hasTouch, hold, kind, layout, loadDB, loadGrid, loadGridHandleTouch, multitouch, nextPath, nextStroke, onReady, panPos, redo, redraw, rootX, rootY, save, scale, showLoadGrid, strokes, touchend, touchmove, touchstart, transform, use, zoomFn;
  ...
  drawEntry = function(entry, i, count, x, y) {
    var d, drawing, dx, dy, fn, fontSize, maxX, maxY, minX, minY, next, px, py, rescale, size, stroke, texts, update, _i, _j, _k, _l, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
    if (1 === i) {
      drawing = {
        prev: null,
        path: []
    ...
    for (dx = _k = _ref2 = -window.devicePixelRatio, _ref3 = window.devicePixelRatio, _ref4 = window.devicePixelRatio * .5; _ref4 > 0 ? _k <= _ref3 : _k >= _ref3; dx = _k += _ref4) {
      for (dy = _l = _ref5 = -window.devicePixelRatio, _ref6 = window.devicePixelRatio, _ref7 = window.devicePixelRatio * .5; _ref7 > 0 ? _l <= _ref6 : _l >= _ref6; dy = _l += _ref7) {
